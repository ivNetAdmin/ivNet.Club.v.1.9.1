    ...
    public class NHibernateHelper
    {
        ...
        private static string GetConnectionString()
        {
            ...
            var connectionString =
                configuration.ConnectionStrings.ConnectionStrings["ivNet.Club.ConnectionString"].ConnectionString;

            _dbFile = HttpContext.Current.ApplicationInstance.Server.MapPath("~/Modules/ivNet.Club/App_Data");
